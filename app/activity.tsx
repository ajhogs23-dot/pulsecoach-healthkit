...
const styles = StyleSheet.create({
  ...
  stat: { flex: 1, minHeight: 135, backgroundColor: "rgba(66, 132, 174, 0.38)", borderRadius: 18, padding: 15, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.40)" },
  ...
  card: { backgroundColor: "rgba(66, 132, 174, 0.38)", borderRadius: 20, padding: 17, gap: 13, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.46)" },
  ...
  input: { backgroundColor: "rgba(10, 43, 67, 0.50)", borderRadius: 13, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.46)", padding: 13, color: "#F4F7F0", fontWeight: "800" },
  choiceRow: { flexDirection: "row", gap: 8 },
  choice: { paddingHorizontal: 13, paddingVertical: 10, borderRadius: 12, backgroundColor: "rgba(10, 43, 67, 0.50)", borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.46)" },
  ...
  info: { padding: 16, backgroundColor: "rgba(76, 143, 184, 0.40)", borderRadius: 18, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.54)" },
  activityList: { padding: 16, gap: 10, backgroundColor: "rgba(76, 143, 184, 0.40)", borderRadius: 18, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.54)" },
