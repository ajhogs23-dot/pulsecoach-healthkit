...
const mint = "#B8F36B";
const bg = "#111513";
const surface = "rgba(66, 132, 174, 0.38)";
const muted = "#A8B3A6";
...
export default function HomeScreen() {
  ...
  return (
    <ScreenContainer containerClassName="bg-background" className="px-5 pt-3">
      <TabBackground source={require("@/assets/images/tab-backgrounds/today.png")} opacity={0.34} />
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.metricGrid}>
          <Metric icon="figure.walk" label="Movement" value={summary?.steps === undefined ? "—" : Math.round(summary.steps).toLocaleString("en-AU")} note={connected ? "steps · map · daily calories" : "Connect Apple Health"} onPress={() => router.push("/movement" as any)} />
