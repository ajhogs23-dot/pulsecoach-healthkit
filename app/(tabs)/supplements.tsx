...
const styles = StyleSheet.create({
  ...
  search: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "rgba(10, 43, 67, 0.50)", borderRadius: 14, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.58)", paddingHorizontal: 13 },
  searchInput: { flex: 1, color: "#F4F7F0", paddingVertical: 14 },
  actions: { flexDirection: "row", gap: 9 },
  action: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, backgroundColor: "rgba(54, 119, 161, 0.46)", borderRadius: 13, padding: 12 },
  actionText: { color: mint, fontWeight: "800", fontSize: 12 },
  results: { backgroundColor: "rgba(66, 132, 174, 0.38)", borderRadius: 17, padding: 13, gap: 9, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.54)" },
  ...
  reviewCard: { backgroundColor: "rgba(76, 143, 184, 0.40)", borderRadius: 17, padding: 14, gap: 11, borderWidth: 2, borderColor: mint },
  ...
  cancelButton: { flex: 1, alignItems: "center", borderRadius: 13, padding: 13, backgroundColor: "rgba(54, 119, 161, 0.46)" },
  ...
  form: { backgroundColor: "rgba(66, 132, 174, 0.38)", borderRadius: 16, padding: 13, gap: 10 },
  input: { backgroundColor: "rgba(10, 43, 67, 0.50)", color: "#F4F7F0", borderRadius: 12, padding: 13, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.46)" },
  ...
  item: { backgroundColor: "rgba(66, 132, 174, 0.38)", borderRadius: 17, padding: 14, flexDirection: "row", alignItems: "center", gap: 12, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.40)" },
