...
const styles = StyleSheet.create({
  ...
  formCard: { minHeight: 190, backgroundColor: "rgba(66, 132, 174, 0.38)", borderRadius: 25, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.46)", alignItems: "center", justifyContent: "center", padding: 22 },
  ...
  progressionCard: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "rgba(76, 143, 184, 0.40)", borderRadius: 15, padding: 13, borderWidth: 1, borderColor: "#4D653D" },
  ...
  input: { backgroundColor: "rgba(10, 43, 67, 0.50)", borderRadius: 13, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.58)", padding: 13, color: "#F4F7F0", fontWeight: "800" },
  loggedSets: { backgroundColor: "rgba(76, 143, 184, 0.40)", borderRadius: 15, padding: 13, gap: 6, borderWidth: 1, borderColor: "rgba(174, 224, 255, 0.54)" },
