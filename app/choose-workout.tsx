...
const styles = StyleSheet.create({
  ...
  chip: { minHeight: 44, justifyContent: "center", paddingVertical: 10, paddingHorizontal: 12, borderRadius: 13, backgroundColor: "#1B231D", borderWidth: 1, borderColor: "#2D392E" },
  ...
  input: { backgroundColor: "#111513", borderWidth: 1, borderColor: "#2D392E", borderRadius: 13, padding: 13, color: "#F4F7F0", fontSize: 14 },
  multiline: { minHeight: 82, textAlignVertical: "top" },
  row: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  smallChip: { minHeight: 44, justifyContent: "center", paddingVertical: 10, paddingHorizontal: 12, borderRadius: 12, backgroundColor: "#1B231D", borderWidth: 1, borderColor: "#2D392E" },
  choiceStack: { gap: 8 },
  choiceCard: { minHeight: 58, flexDirection: "row", alignItems: "center", paddingVertical: 10, paddingHorizontal: 13, borderRadius: 14, backgroundColor: "#1B231D", borderWidth: 1, borderColor: "#2D392E" },
  ...
  preview: { backgroundColor: "#202A21", borderRadius: 18, padding: 16, borderWidth: 1, borderColor: "#354536", gap: 8, marginTop: 6 },
