...
export default function GymScreen() {
  const openBuilder = (focus: string) => router.push({ pathname: "/workout", params: { focus, equipment: "Full gym" } } as any);
  return <ScreenContainer className="px-5 pt-4"><ScrollView contentContainerStyle={styles.content}>
    ...
    <View style={styles.grid}>
      ...
      <Tile title="Bodyweight" detail="Push-ups, pull-ups, dips, core and more" onPress={() => router.push({ pathname: "/workout", params: { focus: "Full body", equipment: "Bodyweight" } } as any)} />
    </View>
...
const styles = StyleSheet.create({ content: { gap: 14, paddingBottom: 35 }, back: { color: mint, fontWeight: "800" }, eyebrow: { color: mint, fontSize: 11, fontWeight: "900", letterSpacing: 1.4 }, title: { color: "#F4F7F0", fontSize: 30, fontWeight: "900" }, subtitle: { color: muted, lineHeight: 20 }, section: { color: "#DCE5D8", fontSize: 11, fontWeight: "900", letterSpacing: 1.1, marginTop: 5 }, grid: { flexDirection: "row", flexWrap: "wrap", justifyContent: "space-between", rowGap: 10 }, tile: { width: "48.5%", minHeight: 150, borderRadius: 18, padding: 14, backgroundColor: "#1B231D", borderWidth: 1, borderColor: "#304033" }, mark: { width: 39, height: 39, borderRadius: 13, backgroundColor: "#2B3B27", alignItems: "center", justifyContent: "center" }, tileTitle: { color: "#F4F7F0", fontSize: 14, fontWeight: "900", marginTop: 13 }, tileCopy: { color: muted, fontSize: 10.5, lineHeight: 15, marginTop: 5 }, scan: { flexDirection: "row", alignItems: "center", gap: 11, borderRadius: 16, padding: 14, backgroundColor: "#202A21", borderWidth: 1, borderColor: "#3B4A3B" }, flex: { flex: 1 }, scanTitle: { color: "#F4F7F0", fontWeight: "900" }, scanCopy: { color: muted, fontSize: 11, marginTop: 3 }, note: { color: "#718071", fontSize: 11, lineHeight: 16, textAlign: "center" }, pressed: { opacity: 0.75, transform: [{ scale: 0.98 }] } });
